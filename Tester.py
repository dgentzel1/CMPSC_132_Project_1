    ...
    if not advisor_list:
        ...
        while advisor:
            ...
            if s == name:
                ...
                title = input(f'Name ({advisor.getData().getTitle()}): ') or advisor.getData().getTitle()
                department = input(f'Name ({advisor.getData().getDepartment()}): ') or advisor.getData().getDepartment()
